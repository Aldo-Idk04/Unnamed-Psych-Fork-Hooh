...
class MusicPlayer extends FlxGroup 
{
	...
	public function switchPlayMusic()
	{
		...
		if (playingMusic)
		{
			instance.bottomText.text = Language.getPhrase('musicplayer_tip', "Press SPACE to Pause / Press ESCAPE to Exit / Press R to Reset the Song / Press CTRL to Toggle ON or OFF the voices (if available)");
			positionSong();
